...
<div class="cases-feed-bg">
  <section class="price">
    <div class="container">
      <h2 class="title"><?php the_field('price_title') ?></h2>
      <div class="price-wrap">
        <?php if (have_rows('kartochki')) : while (have_rows('kartochki')) : the_row(); ?>
        <div class="item">
          <b>
            <?php the_sub_field('zagolovok') ?>
            <?php if (get_sub_field('lejbl')) { ?> 
            <div class="label">
              выгодно
            </div>
            <?php } ?>
          ...
          <div class="feat">
            <?php if (have_rows('preimushhestva')) : while (have_rows('preimushhestva')) : the_row(); ?>
            <div class="feat-item">
              <div class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                  <circle cx="12" cy="12.5" r="9" stroke="#D63277" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M15 10.5L11 14.5L9 12.5" stroke="#D63277" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
              <p><?php the_sub_field('tekst') ?></p>
            </div>
          ...
          <div class="costs">
            <div class="costs-main"><?php the_sub_field('czena') ?></div>
            <?php if (get_sub_field('czena_skidki_esli_nado')) { ?>
            <div class="costs-sub"><?php the_sub_field('czena_skidki_esli_nado') ?></div>
            <?php } ?>
          </div>
          <div class="button button-accent call-tarif" data-tarif="<?php the_sub_field('zagolovok') ?>">
            Заказать
          </div>
        </div>
        <?php endwhile; endif; ?>
